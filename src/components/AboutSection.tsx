          ...
          <div className="section-fade">
            <div className="glass-card rounded-2xl p-8 border border-white/8 shadow-glass space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed font-inter">
                I'm <span className="text-primary font-semibold">Anurag Singh</span>, a passionate Computer Science student
            ...
            <div className="relative pl-6">
              ...
              {timeline.map((item, i) => (
                <div key={i} className="relative mb-8 last:mb-0">
                  {/* Dot */}
                  <div className="absolute -left-[1.375rem] top-1 w-3 h-3 rounded-full border-2 border-primary"
