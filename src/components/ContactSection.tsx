...
const socialLinks = [
  {
    ...
    label: "Instagram",
    value: "anurag_.007._",
    href: "https://www.instagram.com/anurag_.007._",
    color: "hsl(330 80% 60%)",
  },
  {
    ...
    label: "LinkedIn",
    value: "Anurag Singh",
    href: "https://www.linkedin.com/in/anurag-singh-754a88373",
    color: "hsl(210 80% 55%)",
  },
  {
    icon: <Github size={20} />,
    label: "GitHub",
    value: "Anurag-techs",
    href: "https://github.com/Anurag-techs",
    color: "hsl(0 0% 85%)",
  },
];
...
const ContactSection = () => {
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText("anurag7595037158@gmail.com");
    setCopied(true);
  ...
  emailjs.sendForm(
    "service_bjahk8i",   // <-- yaha apna service id
    "template_sk3ksyl",  // <-- yaha template id
    formRef.current,
    "I3nXr2BxSl4oG_HUr"    // <-- yaha public key
  )
  .then(() => {
    setSent(true);
    ...
    <section id="contact" ref={sectionRef} className="relative py-32 px-6">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div className="section-fade space-y-6">
            ...
            <div className="glass-card rounded-2xl p-6 border border-white/8 group hover:border-primary/20 transition-all duration-300">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-foreground truncate">anurag7595037158@gmail.com</p>
                </div>
                <button
                  onClick={copyEmail}
            ...
            {/* Phone */}
            {["7595037158", "9007306222"].map((phone) => (
      ...
      <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-white/5 text-center">
        <p className="text-xs text-muted-foreground font-mono">
          © 2025 <span className="text-primary">Anurag SIngh</span>. Crafted with passion & precision.
        </p>
      </div>
    </section>
  );
